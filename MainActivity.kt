...
import androidx.compose.material3.ButtonDefaults // <-- Untuk warna tombol reset
            ...
            MaterialTheme {
                Surface(
                    ...
                    FormRegistrasiScreen(
                        onSubmit = { nama, nim, prodi, semester, email ->
...
fun FormRegistrasiScreen(
    ...
    // untuk kontrol Dialog Konfirmasi Reset
    ...
    Column(
        ...
        Button(
            onClick = {
                if (nama.isBlank() || nim.isBlank() || prodi.isBlank() || semester.isBlank() ||
                    email.isBlank()) {
